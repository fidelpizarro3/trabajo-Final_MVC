...
<form action="index.php?control=producto&accion=actualizar" method="POST" enctype="multipart/form-data" class="card p-4 shadow-sm">
    ...
    <div class="mb-3">
        ...
        <textarea name="detalle" rows="3" class="form-control" required><?= $datos['prodetalle'] ?></textarea>
    </div>
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="index.php?control=producto&accion=listar" class="btn btn-secondary">
            Volver
        </a>
